    ...
    <div className="wrapper">
      ...
      <section className="about" id="about-myself">
        <div className="personal-info">
          ...
          <p className="body-text">
            Hi, I am Michael Kithinji. Full-stack Developer with a combined experience of 1+ years with HTML, CSS, JavaScript, React, Ruby on Rails and remote web development. Apart from Full-stack development, I am also a lab instructor at the university of FAST-NUCES.
          </p>
