      ...
      <section className="about" id="about-myself">
        <div className="personal-info">
          ...
          <p className="body-text">
            ...
            I am highly motivated to acquire new skills and keep myself updated with emerging technologies in the field.
          </p>
          <a href="/" className="connect">
            Let&apos;s connect
          </a>
          {generateLinks()}
          <a className="resume-button" href="./docs/Michael_Kithinji_Resume.pdf" download="Michael Kithinji Resume">
            Download CV
            <svg
              fill="black"
              viewBox="0 0 16 16"
